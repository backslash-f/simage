...
# SImage
A wrapper around [`Core Graphics (CG)`](https://developer.apple.com/documentation/coregraphics) that provides functionalities such as image combination (with orientation handling). There's an example below.

Because it relies on CG, it's already multi-platform, supporting iOS (+ iPadOS), macOS, Mac Catalyst, tvOS and watchOS.
