...
[![ci-status](https://github.com/backslash-f/simage/workflows/CI/badge.svg)](https://github.com/backslash-f/simage/actions?query=workflow%3ACI)
...
# 👉⚠️🗄️ Archived 🗄️⚠️👈
This package is now obsolete. To be replaced by https://github.com/thatfactory/image-tools

# SImage 🖼
A wrapper around [`Core Graphics (CG)`](https://developer.apple.com/documentation/coregraphics) that provides functionalities such as combining images while adjusting their orientation or creating thumbnails of large images. See some examples below.
